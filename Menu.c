...
{	
	...
	char* test1res = "00783_rat.res";
	char* test1cha = "00783_rat.ncha";

	char* test2res = "05934_rl.res";
	char* test2cha = "05934_rl.ncha";

	char* test3res = "07397_pla.res";
	char* test3cha = "07397_pla.ncha";
